...
/*render the quizlist for teacher*/
function renderTeacherQuizlist(data_url,add_url,edit_url,del_url) {
    ...
    var titlelist = [
        "please input the quiz name",
        "please input a number",
        "please choose a type from the drop list",
    ...
    function createQuizList(data) {
        ...
        $("#quiz-table .my-edt-btn").on("click",function () {
            ...
            if($(this).html()==="Edit"){
                $("#"+id+"-row .my-editable").each(function (i) {
                    var value = $(this).html();
                    $(this).html("" +
                        "<input type=\""+typelist[i]+"\" name=\""+ namelist[i] +"\" class='text' value=\""+ value +"\" required='required' title=\""+ titlelist[i] +"\">"
                    );
                });
                /*QA naming*/
        ...
        $("#obj-test-add-btn").on("click",function () {
            ...
            $("#quiz-list-add-btn-row").before("" +
                ...
                "            <input type=\"text\" name=\"tname\" class=\"text\" required='required' title=\""+ titlelist[0] +"\">\n" +
                "        </a>\n" +
                "    </th>\n" +
                "    <td class=\"tid my-editable\">\n" +
                "        <input type=\"number\" name=\"tid\" class=\"text\" required='required' title=\""+ titlelist[1] +"\">\n" +
                "    </td>\n" +
                "    <td class=\"type my-editable text-capitalize\">\n" +
                "        <input type=\"text\" name=\"type\" class=\"text\" list=\"typeList\" required='required' title=\""+ titlelist[2] +"\">\n" +
                ...
                "    </td>\n" +
                "    <td class=\"due my-editable\">\n" +
                "        <input type=\"text\" name=\"due\" class=\"text\" pattern='\\d{4}(\\/)\\d{1,2}\\1\\d{1,2}' required='required' title=\""+ titlelist[3] +"\">\n" +
                "    </td>\n" +
                "    <td class=\"edit-container\" style=\"width: 2rem\">\n" +
...
/*render the quiz list for admin*/
