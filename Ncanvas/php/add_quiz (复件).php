...
*/
				...
				$sql2 = "insert into question (qid,tid,cid,ans,std_score,score,title,uid,question_type) values ('".$q."','".$tid."',".$cid.",'".$choiceA."','".$ans."',".$std_score.",".$score.",'".$title."',".$uid.",".$question_type.")";
				$result2 = $con->query($sql2);
